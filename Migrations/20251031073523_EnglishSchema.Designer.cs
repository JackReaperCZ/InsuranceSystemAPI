...
namespace InsuranceSystemAPI.Migrations
{
    ...
    [Migration("20251031073523_EnglishSchema")]
    partial class EnglishSchema
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InsuranceSystemAPI.Models.InsuredPerson", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 31, 7, 35, 22, 468, DateTimeKind.Utc).AddTicks(294),
            ...
            modelBuilder.Entity("InsuranceSystemAPI.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 10, 31, 7, 35, 22, 466, DateTimeKind.Utc).AddTicks(8929),
                            Email = "admin@insurance.cz",
                            FirstName = "Administrátor",
                            HashedPassword = "$2a$11$m/oUCvFhKx/pMbQ1BtLYCecIdV8Jq6NHOXnl7J2U0wV.Q5ljVbepW",
                            IsActive = true,
                            LastName = "Systému",
                            Role = 1,
                            Username = "admin"
